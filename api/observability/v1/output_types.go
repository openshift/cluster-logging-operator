...
type HTTPAuthentication struct {
	...
	// +kubebuilder:validation:Optional
	// +nullable
	Username *SecretConfigReference `json:"username,omitempty"`

	// Password to use for authenticating requests.
	//
	// +kubebuilder:validation:Optional
	// +nullable
	Password *SecretConfigReference `json:"password,omitempty"`
}
...
type AzureMonitorAuthentication struct {
	...
	// +kubebuilder:validation:Required
	// +nullable
	SharedKey *SecretConfigReference `json:"sharedKey"`
}
...
type CloudwatchIAMRole struct {
	...
	// +kubebuilder:validation:Required
	// +nullable
	RoleARN *SecretConfigReference `json:"roleARN"`
...
type CloudwatchAWSAccessKey struct {
	...
	// +kubebuilder:validation:Required
	// +nullable
	KeyID *SecretConfigReference `json:"keyID"`

	// AccessKeySecret points to the AWS access key secret to be used for authentication.
	//
	// +kubebuilder:validation:Required
	// +nullable
	KeySecret *SecretConfigReference `json:"keySecret"`
}
...
type GoogleCloudLoggingAuthentication struct {
	...
	//
	// +kubebuilder:validation:Required
	Credentials *SecretConfigReference `json:"credentials"`
}
...
type SplunkAuthentication struct {
	...
	//
	// +kubebuilder:validation:Required
	Token *SecretConfigReference `json:"token"`
}
