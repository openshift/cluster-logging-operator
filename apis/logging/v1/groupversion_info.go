...
// +kubebuilder:rbac:groups=apps,resourceNames=cluster-logging-operator,resources=deployments/finalizers,verbs=update
...
// +kubebuilder:rbac:groups=core,resources=pods;services;endpoints;persistentvolumeclaims;events;configmaps;secrets;serviceaccounts;serviceaccounts/finalizers;services/finalizers,verbs=*
...
// +kubebuilder:rbac:groups=security.openshift.io,resources=securitycontextconstraints,verbs=create;use
