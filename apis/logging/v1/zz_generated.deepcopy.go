...
func (in *HTTPReceiver) DeepCopyInto(out *HTTPReceiver) {
	*out = *in
	out.ReceiverPort = in.ReceiverPort
}
...
func (in OutputTuningSpec) DeepCopyInto(out *OutputTuningSpec) {
	{
		in := &in
		*out = make(OutputTuningSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReceiverPort) DeepCopyInto(out *ReceiverPort) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReceiverPort.
func (in *ReceiverPort) DeepCopy() *ReceiverPort {
	if in == nil {
		return nil
	}
	out := new(ReceiverPort)
	in.DeepCopyInto(out)
	return out
}
