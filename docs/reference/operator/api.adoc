...
|ocpConsole|object|  OCPConsole is the specification for the OCP console plugin
...
|logLimit|int|  *(optional)* LogLimit is the max number of entries returned for a query.
