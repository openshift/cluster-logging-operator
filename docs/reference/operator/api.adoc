...
|receiverPort|object|  ReceiverPort specifies parameters for the Service fronting the HTTPReceiver
|======================

=== .spec.inputs[].receiver.http.receiverPort
===== Description
...
|name|string|  *(optional)* Name of the service to create for this HTTPReceiver
|port|int|  Port the Service will listen on.
|targetPort|int|  *(optional)* Port the Receiver will listen on.
|======================
...
|limit|object|  *(optional)* Limit applied to the aggregated log
