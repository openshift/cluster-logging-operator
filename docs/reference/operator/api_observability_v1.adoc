...
|otlpTraceContext|object|  OtlpTraceContext allows custom regex patterns for extracting trace context (trace_id, span_id, trace_flags) from log messages when data model is &#39;Otel&#39;.
...
=== .spec.outputs[].lokiStack.otlpTraceContext
...
|additionalSpanIdFieldNames|array|  AdditionalSpanIdFieldNames specifies alternative field names to search for span_id in log messages.
...
|additionalTraceFlagsFieldNames|array|  AdditionalTraceFlagsFieldNames specifies alternative field names to search for trace_flags in log messages.
...
|additionalTraceIdFieldNames|array|  AdditionalTraceIdFieldNames specifies alternative field names to search for trace_id in log messages.
...
|customPatterns|array|  CustomPatterns allows defining arbitrary regex patterns for extracting trace context from complex log formats.
...
=== .spec.outputs[].lokiStack.otlpTraceContext.additionalSpanIdFieldNames[]

Type:: array

=== .spec.outputs[].lokiStack.otlpTraceContext.additionalTraceFlagsFieldNames[]

Type:: array

=== .spec.outputs[].lokiStack.otlpTraceContext.additionalTraceIdFieldNames[]

Type:: array

=== .spec.outputs[].lokiStack.otlpTraceContext.customPatterns[]
...
|otlpTraceContext|object|  OtlpTraceContext allows custom regex patterns for extracting trace context (trace_id, span_id, trace_flags) from log messages
...
=== .spec.outputs[].otlp.otlpTraceContext
...
=== .spec.outputs[].otlp.otlpTraceContext.additionalSpanIdFieldNames[]

Type:: array

=== .spec.outputs[].otlp.otlpTraceContext.additionalTraceFlagsFieldNames[]

Type:: array

=== .spec.outputs[].otlp.otlpTraceContext.additionalTraceIdFieldNames[]

Type:: array

=== .spec.outputs[].otlp.otlpTraceContext.customPatterns[]
