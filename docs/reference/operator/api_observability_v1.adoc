...
|keyPrefix|string|  KeyPrefix is a templated string that defines the S3 key prefix for log objects.
...
If using a prefix for this purpose, it must end in / to act as a directory path. A trailing / is not automatically added.
