...
|deliveryMode|string|  
|maxBufferSize|object|  MaxBufferSize is the maximum size in bytes allowed for buffering unsent data to an output.
...
=== .spec.outputs[].azureMonitor.tuning.maxBufferSize
...
=== .spec.outputs[].azureMonitor.tuning.maxBufferSize.d
...
=== .spec.outputs[].azureMonitor.tuning.maxBufferSize.d.Dec
...
=== .spec.outputs[].azureMonitor.tuning.maxBufferSize.d.Dec.unscaled
...
=== .spec.outputs[].azureMonitor.tuning.maxBufferSize.d.Dec.unscaled.abs

Type:: Word

=== .spec.outputs[].azureMonitor.tuning.maxBufferSize.i
...
|messageTimeout|Duration|  MessageTimeout messages that are waiting to be sent are dropped after this timeout.
...
=== .spec.outputs[].kafka.tuning.messageTimeout
...
|url|string|  An absolute URL, with a scheme. Valid schemes are: `tcp`, `tls`, `udp` and `udps`
