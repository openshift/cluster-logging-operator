...
|topic|string|  Topic specifies the target topic to send logs to.
...
|labelKeys|array|  LabelKeys is a list of log record keys that will be used as Loki labels with the corresponding log record value.
...
|msgID|string|  MsgID is MSGID part of the syslog-msg header
...
|procID|string|  ProcID is PROCID part of the syslog-msg header
