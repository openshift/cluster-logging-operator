...
os::test::junit::declare_suite_start "[LogExplorationAPI] API"

start_seconds=$(date +%s)

TEST_DIR=${TEST_DIR:-'./test/e2e/logexplorationapi/*/'}
...
for dir in $(ls -d $TEST_DIR); do
  os::log::info "=========================================================="
  os::log::info "Starting test of log exploration api $dir"
  os::log::info "=========================================================="
  ...
  artifact_dir=$ARTIFACT_DIR/logexplorationapi/$(basename $dir)
  ...
  if CLEANUP_CMD="$( cd $( dirname ${BASH_SOURCE[0]} ) >/dev/null 2>&1 && pwd )/../../test/e2e/collection/cleanup.sh $artifact_dir $GENERATOR_NS" \
    ...
    os::log::info "======================================================="
    os::log::info "LogExplorationAPI $dir passed"
    os::log::info "======================================================="
  else
    failed=1
    os::log::info "======================================================="
    os::log::info "LogExplorationAPI $dir failed"
    os::log::info "======================================================="
  fi
