...
var _ = Describe("Factory#NewPodSpec", func() {
	...
	BeforeEach(func() {
		...
		podSpec = *factory.NewPodSpec(nil, logging.ClusterLogForwarderSpec{}, "1234", "", tls.GetClusterTLSProfileSpec(nil), []string{})
	...
	Describe("when creating the podSpec", func() {
		...
		Context("and the proxy config exists", func() {
			...
			It("should add the proxy variables to the collector", func() {
				...
				}, logging.ClusterLogForwarderSpec{}, "1234", "", tls.GetClusterTLSProfileSpec(nil), []string{})
				collector = podSpec.Containers[0]
		...
		Context("and using custom named ClusterLogForwarder", func() {
			...
			It("should have custom named podSpec resources based on CLF name", func() {
				...
				}, logging.ClusterLogForwarderSpec{}, "foobar", "", tls.GetClusterTLSProfileSpec(nil), []string{})
		...
		Context("when collector has a secret containing a credentials key", func() {
			...
			It("should NO LONGER be setting AWS ENV vars in the container", func() {
				podSpec := *factory.NewPodSpec(nil, logging.ClusterLogForwarderSpec{
					Outputs:   outputs,
					Pipelines: pipelines,
				}, "1234", "", tls.GetClusterTLSProfileSpec(nil), []string{})
				collector := podSpec.Containers[0]
