...
var _ = Describe("Testing Config Generation", func() {
	...
	var f = func(clspec loggingv1.CollectionSpec, secrets map[string]*corev1.Secret, clfspec loggingv1.ClusterLogForwarderSpec, op framework.Options) []framework.Element {
