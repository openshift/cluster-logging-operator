...
inputs = {{.Inputs}}
languages = ["All"]
group_by = ["._internal.kubernetes.namespace_name","._internal.kubernetes.pod_name","._internal.kubernetes.container_name", "._internal.kubernetes.pod_id", "_internal.kubernetes.io_stream"]
