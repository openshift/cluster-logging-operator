...
resource.attributes = append( resource.attributes,
	[{"key": "kubernetes.pod_name", "value": {"stringValue": get!(.,["kubernetes","pod_name"])}},
	{"key": "kubernetes.container_name", "value": {"stringValue": get!(.,["kubernetes","container_name"])}},
	{"key": "kubernetes.namespace_name", "value": {"stringValue": get!(.,["kubernetes","namespace_name"])}}]
)
`
)
