...
func (clusterRequest *ClusterLoggingRequest) CreateOrUpdateCollection() (err error) {
	...
	if err := collector.ReconcilePrometheusRule(clusterRequest.EventRecorder, clusterRequest.Client, clusterRequest.Cluster.Spec.Collection.Type, clusterRequest.Forwarder.Namespace, constants.CollectorName, clusterRequest.ResourceOwner); err != nil {
