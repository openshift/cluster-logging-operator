...
func Reconcile(lfmeInstance *loggingv1alpha1.LogFileMetricExporter,
	...
	if err := network.ReconcileService(er, requestClient, lfmeInstance.Namespace, resNames.CommonName, lfmeInstance.Name, constants.LogfilesmetricexporterName, ExporterPortName, ExporterMetricsSecretName, ExporterPort, owner, commonLabels); err != nil {
