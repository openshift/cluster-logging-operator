...
// telemetry metrics.
//
// In openshift-logging just having a ClusterLogging instance without an associated ClusterLogForwarder is a valid
// configuration. So the "default ClusterLogForwarder instance" might not even exist or, even when it exists,
// might not contain all the information.
func (t *telemetryCollector) updateDefaultInfo(forwarder *loggingv1.ClusterLogForwarder) {
	...
	t.defaultCLFInfo.Healthy = hasReadyCondition(forwarder.Status.Conditions)
