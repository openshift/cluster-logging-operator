...
log_forwarder_output_info{cloudwatch="0",default="1",elasticsearch="1",fluentdForward="0",googleCloudLogging="0",http="0",kafka="0",loki="0",resource_name="instance",resource_namespace="openshift-logging",splunk="0",syslog="0"} 1
...
`
			...
			It("should update the metrics", func() {
				...
				k8s := newFakeClient(cl, forwarder)
