...
log_forwarder_output_info{cloudwatch="0",default="0",elasticsearch="0",fluentdForward="0",googleCloudLogging="0",http="0",kafka="0",loki="0",resource_name="instance",resource_namespace="openshift-logging",splunk="0",syslog="0"} 1
...
# HELP log_forwarder_input_info Info metric containing information about usage of pre-defined input names. Value is always 1.
# TYPE log_forwarder_input_info gauge
log_forwarder_input_info{application="0",audit="0",infrastructure="0",resource_name="test-name",resource_namespace="test-namespace"} 1
# HELP log_forwarder_output_info Info metric containing information about usage of available output types. Value is always 1.
# TYPE log_forwarder_output_info gauge
log_forwarder_output_info{cloudwatch="0",default="0",elasticsearch="0",fluentdForward="0",googleCloudLogging="0",http="0",kafka="0",loki="0",resource_name="test-name",resource_namespace="test-namespace",splunk="0",syslog="0"} 1
# HELP log_forwarder_pipeline_info Info metric containing information about deployed forwarders. Value is always 1.
# TYPE log_forwarder_pipeline_info gauge
...
# HELP log_forwarder_output_info Info metric containing information about usage of available output types. Value is always 1.
# TYPE log_forwarder_output_info gauge
log_forwarder_output_info{cloudwatch="0",default="1",elasticsearch="0",fluentdForward="0",googleCloudLogging="0",http="0",kafka="0",loki="1",resource_name="instance",resource_namespace="openshift-logging",splunk="0",syslog="0"} 1
# HELP log_forwarder_pipeline_info Info metric containing information about deployed forwarders. Value is always 1.
# TYPE log_forwarder_pipeline_info gauge
...
`
				...
				ctx := context.Background()
				k8s := newFakeClient(cl, testDefaultLokiForwarder, lfme)
				collector := newTelemetryCollector(ctx, k8s, testVersion)
