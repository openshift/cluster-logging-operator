...
var _ = Describe("Validating tech-preview annotation", func() {
	// We only need to test 'otlp' output, since 'lokiStack' is migrated internally to an 'otlp' output
	// when sending Otel data model.  Otherwise, the lokiStack type becomes type 'loki' internally
