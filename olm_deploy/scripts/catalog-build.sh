#!/bin/sh
set -eo pipefail
LOCAL_IMAGE_CLUSTER_LOGGING_OPERATOR_REGISTRY=${LOCAL_IMAGE_CLUSTER_LOGGING_OPERATOR_REGISTRY:-127.0.0.1:5000/openshift/cluster-logging-operator-registry}
