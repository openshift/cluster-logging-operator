...
LOGGING_VERSION=${LOGGING_VERSION:-5.6}
LOGGING_FLUENTD_VERSION=${LOGGING_FLUENTD_VERSION:-1.14.6}
LOGGING_VECTOR_VERSION=${LOGGING_VECTOR_VERSION:-v0.21-rh}
LOGGING_LOG_FILE_METRIC_EXPORTER_VERSION=${LOGGING_LOG_FILE_METRIC_EXPORTER_VERSION:-1.1}
LOGGING_CONSOLE_PLUGIN_VERSION=${LOGGING_CONSOLE_PLUGIN_VERSION:-latest}
