...
LOGGING_VERSION=${LOGGING_VERSION:-6.2}

LOGGING_VECTOR_VERSION=release-6.1
LOGGING_LOG_FILE_METRIC_EXPORTER_VERSION=${LOGGING_LOG_FILE_METRIC_EXPORTER_VERSION:-6.2}
