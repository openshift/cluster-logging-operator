...
import (
	inputs "github.com/openshift/cluster-logging-operator/pkg/apis/logging/v1/inputs"
	outputs "github.com/openshift/cluster-logging-operator/pkg/apis/logging/v1/outputs"
	status "github.com/openshift/cluster-logging-operator/pkg/apis/logging/v1/status"
...
func (in *InputSpec) DeepCopyInto(out *InputSpec) {
	*out = *in
	...
	if in.Infrastructure != nil {
		...
		*out = new(inputs.Infrastructure)
		**out = **in
	}
	if in.Audit != nil {
		in, out := &in.Audit, &out.Audit
		*out = new(inputs.Audit)
		**out = **in
	}
	return
}
