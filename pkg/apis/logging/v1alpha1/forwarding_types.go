...
const (
	...
	//OutputTypeSyslog configures pipeline to send messages to an external syslog server
...
// LogForwardingReasonObsolete represents that the LogForwarding resource is obsolete
const LogForwardingReasonObsolete = "ResourceObsolete"
...
const (
	...
	//LogForwardingStateObsolete is when the resource is obsolete by the ClusterLogForwarder
	LogForwardingStateObsolete LogForwardingState = "Obsolete"
)
