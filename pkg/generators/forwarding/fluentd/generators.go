...
func NewConfigGenerator(includeLegacyForwardConfig, includeLegacySyslogConfig, useOldRemoteSyslogPlugin bool) (*ConfigGenerator, error) {
	generator, err := NewConfigGeneratorWithSourceGenerator(includeLegacyForwardConfig, includeLegacySyslogConfig, useOldRemoteSyslogPlugin, nil)
	generator.sourceGenerate = func(inputSources sets.String) (results []string, err error) {
		return generator.GenerateSources(inputSources)
	}
	return generator, err
}

//NewConfigGenerator creates an instance of FluentdConfigGenerator
func NewConfigGeneratorWithSourceGenerator(includeLegacyForwardConfig, includeLegacySyslogConfig, useOldRemoteSyslogPlugin bool, sourceGenerator sources.SourceGenerator) (*ConfigGenerator, error) {
	...
	generator := &ConfigGenerator{
		...
		sourceGenerate:             sourceGenerator,
	}
