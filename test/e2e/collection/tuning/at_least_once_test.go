...
var _ = Describe("[tuning] deliveryMode AtLeastOnce", func() {
	...
	BeforeEach(func() {
		...
		if err := e2e.DeployLogGeneratorWithNamespaceAndLabels(generatorNS, componentName, map[string]string{
			"testtype":  "myinfra",
			"component": componentName,
		}, framework.LogGeneratorOptions{
			Count:          0,
