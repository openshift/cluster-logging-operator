...
var _ = Describe("[Functional][LogForwarding][Normalization] tests for message format", func() {
	...
	DescribeTable("when evaluating an application message", func(expLevel, message string) {
		...
		Entry("should recognize a WARNING message", "warning", "Warning: failed to query journal: Bad message OS Error 74"),
		...
		Entry("should recognize an ERR message", "err", "E0427 02:47:01.619035 1 authentication.go:53] Unable to authenticate the request due to an error: invalid bearer token, context canceled"),
		Entry("should recognize an CRIT message", "crit", "CRITICAL:  Unable to connect to server"),
