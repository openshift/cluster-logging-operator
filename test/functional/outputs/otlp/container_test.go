...
var _ = Describe("[Functional][Outputs][OTLP] Functional tests", func() {
	...
	DescribeTable("should send logs with trace context", func(message string, expectedTraceID, expectedSpanID string, expectedFlag uint32) {
		...
		Entry("should still send logs if trace_id is not standard",
			`{"trace_id": "not-valid", "span_id": "b7ad6b7169203331", "trace_flags": "0"}`,
			"", "b7ad6b7169203331", uint32(0),
		),
		Entry("should still send logs if span_id is not standard",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319c", "span_id": "not-valid", "trace_flags": "01"}`,
			"0af7651916cd43dd8448eb211c80319c", "", uint32(1),
		),
		Entry("should still send logs if trace_flags is not standard",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319c", "span_id": "b7ad6b7169203331", "trace_flags": "not-valid"}`,
			"0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", uint32(0),
		),
		Entry("should still send logs if trace_id, span_id, and trace_flags are not standard",
			`{"trace_id": "not-valid", "span_id": "not-valid", "trace_flags": "not-valid"}`,
			"", "", uint32(0),
		),
		Entry("should extract trace_id from JSON when span_id is absent",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319c", "trace_flags": "0"}`,
			"0af7651916cd43dd8448eb211c80319c", "", uint32(0),
		),
		Entry("should extract span_id from JSON when trace_id is absent",
			`{"span_id": "b7ad6b7169203331", "trace_flags": "01"}`,
			"", "b7ad6b7169203331", uint32(1),
		),
		Entry("should reject trace_id that is too short",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319", "span_id": "b7ad6b7169203331", "trace_flags": "01"}`,
			"", "b7ad6b7169203331", uint32(1),
		),
		Entry("should reject span_id that is too short",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319c", "span_id": "b7ad6b716920333", "trace_flags": "01"}`,
			"0af7651916cd43dd8448eb211c80319c", "", uint32(1),
		),
		Entry("should reject trace_flags that is too long",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319c", "span_id": "b7ad6b7169203331", "trace_flags": "011"}`,
			"0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", uint32(0),
		),
		Entry("should downcase uppercase hex in JSON trace context",
			`{"trace_id": "0AF7651916CD43DD8448EB211C80319C", "span_id": "B7AD6B7169203331", "trace_flags": "01"}`,
			"0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", uint32(1),
		),
		Entry("should handle trace_flags as integer in JSON",
			`{"trace_id": "0af7651916cd43dd8448eb211c80319c", "span_id": "b7ad6b7169203331", "trace_flags": 1}`,
			"0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", uint32(1),
		),
		Entry("should reject non-hex characters in trace_id",
			`{"trace_id": "0zf7651916cd43dd8448eb211c80319c", "span_id": "b7ad6b7169203331", "trace_flags": "01"}`,
			"", "b7ad6b7169203331", uint32(1),
		),
		Entry("should extract only trace_id from plain text when other fields are absent",
			`Processing request trace_id=0af7651916cd43dd8448eb211c80319c`,
			"0af7651916cd43dd8448eb211c80319c", "", uint32(0),
		),
		Entry("should extract trace context with camelCase keys",
			`traceId=0af7651916cd43dd8448eb211c80319c spanId=b7ad6b7169203331 traceFlags=01`,
			"0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", uint32(1),
		),
		Entry("should not capture trace_flags that are not 0 or 1, 00, or 01",
			`traceId=0af7651916cd43dd8448eb211c80319c spanId=b7ad6b7169203331 traceFlags=0A`,
			"0af7651916cd43dd8448eb211c80319c", "b7ad6b7169203331", uint32(0),
		),
	)
})
